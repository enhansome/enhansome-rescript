...
### **Awesome ReScript** [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 495,535 | 🐛 100 | 📅 2026-06-30

A collection of awesome things about the ReScript programming language and toolchain. Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 495,535 | 🐛 100 | 📅 2026-06-30 list thing. [Contributions](#contribute) are always welcome.
...
If no bindings exist yet, you can generate a starting point from the library's TypeScript types with [rescript-bindgen](https://github.com/juspay/rescript-bindgen) ⭐ 9 | 🐛 14 | 🌐 ReScript | 📅 2026-08-13 — a deterministic `.d.ts` → ReScript binding generator (type-safe, no `%identity`), which you then tweak to your needs.
