# Awesome rescript with stars

![awesome-rescript](https://user-images.githubusercontent.com/18074327/137881925-cb1ffc9e-11ed-45f8-bb72-afa1ae6a6fea.png)

### **Awesome ReScript** [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 495,898 | 🐛 100 | 📅 2026-06-30

A collection of awesome things about the ReScript programming language and toolchain. Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 495,898 | 🐛 100 | 📅 2026-06-30 list thing. [Contributions](#contribute) are always welcome.
...
* [Bindings cookbook by ReScriptBR](https://github.com/rescriptbr/rescript-bindings-cookbook) ⭐ 58 | 🐛 0 | 📅 2021-08-28
* [ReScript Tutorial by protoship.io](https://github.com/protoship/rescript-tutorial) ⭐ 41 | 🐛 4 | 🌐 ReScript | 📅 2022-05-21
...
If no bindings exist yet, you can generate a starting point from the library's TypeScript types with [rescript-bindgen](https://github.com/juspay/rescript-bindgen) ⭐ 9 | 🐛 14 | 🌐 ReScript | 📅 2026-08-14 — a deterministic `.d.ts` → ReScript binding generator (type-safe, no `%identity`), which you then tweak to your needs.
...
* [VIM-ReScript](https://github.com/rescript-lang/vim-rescript) ⭐ 162 | 🐛 13 | 🌐 Vim Script | 📅 2026-08-08
...
The official snippets included with the ReScript-VSCode extension are available [here](https://github.com/rescript-lang/rescript-vscode/blob/master/snippets.json) ⭐ 351 | 🐛 169 | 🌐 ReScript | 📅 2026-08-10. You don't need to do anything to activate them; the extension already installs them.
...
* [Coronate](https://github.com/johnridesabike/coronate) ⭐ 175 | 🐛 8 | 🌐 ReScript | 📅 2026-07-25 - A Swiss-style chess tournament manager for the web and desktop, written with ReScript-React. [(web demo)](https://coronate.netlify.app/)
...
* [Movie and People browsing site](https://github.com/nyinyithann/bioscopes) ⭐ 4 | 🐛 0 | 🌐 ReScript | 📅 2022-11-21 - A site to browse movies and people from The Movie Database (TMDB). [(demo)](https://www.bioscopes.fun)
